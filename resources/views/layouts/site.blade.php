  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <a class="getstarted scrollto" href="#about"> تسجيل دخول</a>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>اختيار منصة لمساحات العمل هو الخطوة الصحيحة لتعزيز الإنتاجية وتحقيق النجاح في مجال العمل. انضم إلى المنصة
