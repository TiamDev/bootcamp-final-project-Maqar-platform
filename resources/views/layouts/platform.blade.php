        ...
        <a class="nav-link " href="index.html">
          ...
          <span> </span>
            ...
            <li class="nav-item">
                <a class="nav-link 
        @if (
            !(Route::currentRouteName() === 'platform.users' ||
                Route::currentRouteName() === 'platform.users.add' ||
                Route::currentRouteName() === 'platform.users.edit' ||
                Route::currentRouteName() === 'platform.users.view' ||
                Route::currentRouteName() === 'platform.users.delete' ||
                Route::currentRouteName() === 'platform.roles' ||
                Route::currentRouteName() === 'platform.roles.add' ||
                Route::currentRouteName() === 'platform.roles.edit' ||
                Route::currentRouteName() === 'platform.roles.view' ||
                Route::currentRouteName() === 'platform.roles.delete'
            )) collapsed @endif"
                    data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>الحسابات</span><i
                        class="bi bi-chevron-down me-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('platform.users') }}"
                            class="@if (Route::currentRouteName() === 'platform.users' ||
                                    Route::currentRouteName() === 'platform.users.add' ||
                                    Route::currentRouteName() === 'platform.users.edit' ||
                                    Route::currentRouteName() === 'platform.users.view' ||
                                    Route::currentRouteName() === 'platform.users.delete') active @endif">
                            <i class="bi bi-circle "></i><span>المستخدمين</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('platform.roles') }}"
                            class="@if (Route::currentRouteName() === 'platform.roles' ||
                                    Route::currentRouteName() === 'platform.roles.add' ||
                                    Route::currentRouteName() === 'platform.roles.edit' ||
                                    Route::currentRouteName() === 'platform.roles.view' ||
                                    Route::currentRouteName() === 'platform.roles.delete') active @endif">
            ...
            <li class="nav-item">
                <a class="nav-link 
        @if (
            !(Route::currentRouteName() === 'tenant.users' ||
                Route::currentRouteName() === 'tenant.users.add' ||
                Route::currentRouteName() === 'tenant.users.edit' ||
                Route::currentRouteName() === 'tenant.users.view' ||
                Route::currentRouteName() === 'tenant.users.delete' ||
                Route::currentRouteName() === 'tenant.roles' ||
                Route::currentRouteName() === 'tenant.roles.add' ||
                Route::currentRouteName() === 'tenant.roles.edit' ||
                Route::currentRouteName() === 'tenant.roles.view' ||
                Route::currentRouteName() === 'tenant.roles.delete'
            )) collapsed @endif"
                    data-bs-target="#tenant-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>الحسابات</span><i
                        class="bi bi-chevron-down me-auto"></i>
                </a>
                <ul id="tenant-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ route('tenant.users') }}"
                            class="@if (Route::currentRouteName() === 'tenant.users' ||
                                    Route::currentRouteName() === 'tenant.users.add' ||
                                    Route::currentRouteName() === 'tenant.users.edit' ||
                                    Route::currentRouteName() === 'tenant.users.view' ||
                                    Route::currentRouteName() === 'tenant.users.delete') active @endif">
                            <i class="bi bi-circle "></i><span>المستخدمين</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('tenant.roles') }}"
                            class="@if (Route::currentRouteName() === 'tenant.roles' ||
                                    Route::currentRouteName() === 'tenant.roles.add' ||
                                    Route::currentRouteName() === 'tenant.roles.edit' ||
                                    Route::currentRouteName() === 'tenant.roles.view' ||
                                    Route::currentRouteName() === 'tenant.roles.delete') active @endif">
                            <i class="bi bi-circle"></i><span>الأدوار</span>
                        </a>
                    </li>
