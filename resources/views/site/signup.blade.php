  ...
  <div class="container img-box-container-signup">
    <div class="background-images">
      <div class="">
        ...
        <img src="{{asset('site/img/ill/3d-casual-life-young-man-sitting-with-laptop-and-waving.png')}}" width="260" alt="Background Image 1">
      </div>
      <div class="">

        <img src="{{asset('site/img/ill/3d-casual-life-monitor-and-other-office-stuff.png')}}" width="320" alt="Background Image 2">
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <form>
          ...
          <div class="form-group pb-3">
            ...
            <input type="password" class="form-control" id="conform-password" placeholder="أدخل كلمة المرور">
          </div>
          <div class="row" >
            <div class="col-6">
