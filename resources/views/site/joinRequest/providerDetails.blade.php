    ...
    <section>
        <div class="card card-join">
            ...
            <div class="card-body" dir="rtl">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group pb-3">
                                            <input type="text" class="form-control" name="title[]"
                                                placeholder="أدخل الخدمة الاضافية">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group pb-3">
                                            <input type="number" class="form-control" name="social-link[]"
                ...
                <section>
                    <h4 class="tab-heading">حسابات البنكية </h4>
                    <div class="row">
                        <div class="col-12">
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <input type="time" name="workTime" class="form-control" id=""
                                        width="100">
                                </div>
                                <div class="col-6">
                                    <input type="time" name="workTime" id="" class="form-control"
                                        width="100">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="input-group mb-3" dir="ltr">
                                ...
                                <input type="text" class="form-control social-link" disabled
