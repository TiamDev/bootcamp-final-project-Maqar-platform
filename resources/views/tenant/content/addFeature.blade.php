...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">إضافة مرفق</li>
        ...
        <form class=" g-3" action="{{ route('content.createFeature') }}" method="POST">
            @csrf
                    ...
                    <div class="col-6">
                        <div class="card px-5" dir="rtl">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <label for="inputName5" class="form-label">المرفق</label>
