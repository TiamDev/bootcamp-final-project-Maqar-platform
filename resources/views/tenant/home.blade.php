    ...
    <div class="container">
      <div class="slider-container">
        <div class="small-images">
          <img class="small-image" src="{{ asset('site/img/office/pexels-flo-dahm-699459.jpg') }}" onclick="changeImage('{{ asset('site/img/office/pexels-flo-dahm-699459.jpg') }}')">
          <img class="small-image" src="{{ asset('site/img/office/pexels-lisa-fotios-1957478.jpg') }}" onclick="changeImage('{{ asset('site/img/office/pexels-lisa-fotios-1957478.jpg') }}')">
          <img class="small-image" src="{{ asset('site/img/office/pexels-max-rahubovskiy-7005458.jpg') }}" onclick="changeImage('{{ asset('site/img/office/pexels-max-rahubovskiy-7005458.jpg') }}')">
          <img class="small-image" src="{{ asset('site/img/office/pexels-lisa-fotios-1957478.jpg') }}" onclick="changeImage('{{ asset('site/img/office/pexels-lisa-fotios-1957478.jpg') }}')">
        </div>
    ...
    <div class="row gy-4" data-aos="fade-left" >
      <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
        <div class="service-box">
          <img src="{{asset('site/img/office/pexels-flo-dahm-699459.jpg') }}" class="img-fluid service-img" alt="">
            ...
            <div class="pricing-details ">
              <div class="row">
                <div class="col-12">
                  <div class="row">
                    <div class="col-6">
                      <p class="pricing-amount">يبدأ من <span class="amount">80,000</span> ريال</p>
                    </div>
                    <div class="col-6">
              ...
              <form action="forms/contact.php" method="post" class="php-email-form">
                <div class="row gy-4">
                  <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="inputName5" fdprocessedid="tpewl" placeholder=" ">
                </div>
                <div class="col-6">
                  <label for="inputState" class="form-label">الإيميل </label>
                  <input type="email" class="form-control" id="inputName5" fdprocessedid="tpewl" placeholder=" ">
                </div>
                <div class="col-12">
              ...
              <div class="info-box ">
                ...
                <div class="">
                  <div class="social-links mt-3">
                    <a href="#" class="twitter d-flex"><i class="bi bi-twitter ps-3"></i>http://www.tweeter.com/sanad</a>
