                                ...
                                <div class="col-12 booking-duration">
                                    ...
                                    <div class="input-group mb-3" dir="ltr">
                                        ...
                                        <input type="text" class="form-control price" disabled
                                            placeholder="سعر المساحة بالساعة  " aria-label="Recipient's username"
                                            aria-describedby="basic-addon1" fdprocessedid="agqgdm">
                                        <div class="input-group-text" id="basic-addon1">
                                            <label class="form-check-label" for="gridCheck1">
                                                ساعات
                                            </label>
                                            <input class="form-check-input ms-1" type="checkbox" name="offers[]"
                                                id="gridCheck1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group mb-3" dir="ltr">
                                        ...
                                        <input type="text" class="form-control price" disabled
                                            placeholder="سعر المساحة باليوم  " aria-label="Recipient's username"
                                            aria-describedby="basic-addon2" fdprocessedid="agqgdm">
                                    ...
                                    <div class="input-group mb-3" dir="ltr">
                                        ...
                                        <input type="text" class="form-control price" disabled
                                            placeholder="سعر المساحة بالاسبوع  " aria-label="Recipient's username"
                                    ...
                                    <div class="input-group mb-3" dir="ltr">
                                        <span class="input-group-text" id="basic-addon1">ريال </span>
                                        <input type="text" class="form-control price" disabled
                                            placeholder="سعر المساحة بالشهر  " aria-label="Recipient's username"
                                            aria-describedby="basic-addon4" fdprocessedid="agqgdm">
