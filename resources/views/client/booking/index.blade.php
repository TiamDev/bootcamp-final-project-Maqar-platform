        ...
        <form action="" method="post">
          <div class="row  justify-content-center align-items-center">
            ...
            <div class="col-lg-1 col-sm-4">
              <div class="form-floating search-form">
                <input type="texl" class="form-control" id="floatingInput" placeholder="name@example.com"
                  fdprocessedid="rq0wub">
                                ...
                                <div class="">
                                  ...
                                  <section class="section profile">
                                    <div class="row">
                                            ...
                                            <div id="carouselExampleIndicators" class="carousel slide"
                                              ...
                                              <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                  <img
                                                    src="{{asset('site/img/office/pexels-max-rahubovskiy-7534232.jpg')}}"
                                                    class="d-block w-100 img-spase" alt="...">
                                                </div>
                                                <div class="carousel-item">
                                                  <img
                                                    src="{{asset('site/img/office/pexels-max-rahubovskiy-7534231.jpg')}}"
                                                    class="d-block w-100 img-spase" alt="...">
                                                </div>
                                                <div class="carousel-item">
                                                  <img
                                      ...
                                      <div class="col-xl-12">
                                        <div class="card">
                                          <div class="card-body pt-3" dir="rtl">
                                            <!-- Bordered Tabs -->
                                            <div class="tpt-2">
                                              <div class=" profile-overview" id="profile-overview">
                                                <div class="row">
                                                  <div class="col-lg-6 col-md-4 label "> الاسم </div>
                                                  <div class="col-lg-6 col-md-8"> مكتب 1</div>
                                                </div>
                                                <div class="row">
                                                  <div class="col-lg-6 col-md-4 label">النوع</div>
                                                  <div class="col-lg-6 col-md-8"> مكتب خاص </div>
                                                </div>
                                                <div class="row">
                                                  <div class="col-lg-6 col-md-4 label">عدد الافراد</div>
                                                  <div class="col-lg-6 col-md-8"> 5</div>
                                                </div>
                                                <div class="row">
                                                  <div class="col-lg-6 col-md-4 label">مدة الحجز</div>
                                                  <div class="col-lg-6 col-md-8">
                                                    <ul class="myul ">
                                                      <li>(25000 ري) شهري</li>
                                                      <li>(5000 ري) اسبوعي</li>
                                                    </ul>
                                                  </div>
                                                </div>
                                              </div>
            ...
            <div class="">
              <div class="row">
                <div class="">
                  ...
                  <a href=" {{route('tenant.home')}}" class=" more-info"><small>لمعرفة المزيد عن المكتب</small></a>
                </div>
              </div>
            </div>
          </div>
